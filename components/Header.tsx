  ...
  return (
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="flex flex-col-reverse justify-center items-center t">
          <div
          ...
          <div className="my-2">
            ...
            <span className="bg-violet-800 px-3 py-1 rounded-full text-white">
              {from}
            </span>
          </div>
        </div>
